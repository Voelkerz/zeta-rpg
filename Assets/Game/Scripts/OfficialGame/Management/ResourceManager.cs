...
namespace ZetaGames.RPG {
    ...
    public class ResourceManager : MonoBehaviour {
        // A master list of NPCs that includes their unique ID and a list of owned resouces
        ...
        public void addNPC(int id) {
            if (!npcList.ContainsKey(id)) {
                npcList.Add(id, initializeNpcResources());
            }
        }
        ...
        public Dictionary<ResourceType, int> initializeNpcResources() {
            ...
            resourceList.Add(ResourceType.Coin, 100);
