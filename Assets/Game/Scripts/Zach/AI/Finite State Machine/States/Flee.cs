...
namespace ZetaGames.RPG {
    public class Flee : IState {
        ...
        private readonly AIBrain _gatherer;
        ...
        public Flee(AIBrain gatherer, NavMeshAgent navMeshAgent, EnemyDetector enemyDetector, Animator animator, ParticleSystem particleSystem) {
            _gatherer = gatherer;
